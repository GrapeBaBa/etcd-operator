...
// TODO: We need to change this package with Operator client
...
func UpdateClusterTPRObject(restcli rest.Interface, ns string, e *spec.EtcdCluster) (*spec.EtcdCluster, error) {
...
func UpdateClusterTPRObjectUnconditionally(restcli rest.Interface, ns string, e *spec.EtcdCluster) (*spec.EtcdCluster, error) {
	e.ResourceVersion = ""
	return updateClusterTPRObject(restcli, ns, e)
}
